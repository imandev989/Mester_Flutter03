      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            ...
            : Icon(Icons.home,color: UIColor.mainFontColor),
            label: 'خانه',
          ),
          BottomNavigationBarItem(
            icon: selectedIndex==1
                ? Icon(Icons.category,color: Colors.grey)
                : Icon(Icons.category,color: UIColor.mainFontColor),
            label: 'دسته بندی',
          ...
          BottomNavigationBarItem(
            icon: selectedIndex==2
                ...
                : Icon(Icons.shopping_basket, color: UIColor.mainFontColor),
            label: 'سبد خرید',
          ),
          BottomNavigationBarItem(
            icon: selectedIndex==3
                ? Icon(Icons.article, color: Colors.grey)
                : Icon(Icons.article, color: UIColor.mainFontColor),
            label: 'مستر',
          ),
          BottomNavigationBarItem(
            icon: selectedIndex==4
                ? Icon(Icons.map, color: Colors.grey)
                : Icon(Icons.map, color: UIColor.mainFontColor),
            label: ' نزدیک من',
          ),
          BottomNavigationBarItem(
            icon: selectedIndex==4
                ? Icon(Icons.person, color: Colors.grey)
                : Icon(Icons.person, color: UIColor.mainFontColor),
            label: ' پروفایل',
          ),
        ],
